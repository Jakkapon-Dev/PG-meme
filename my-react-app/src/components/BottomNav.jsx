    ...
    <div className="fixed bottom-0 left-0 right-0 z-30 bg-white/95 backdrop-blur-md border-t border-orange-100/80 px-6 py-2 shadow-lg md:hidden">
      <div className="max-w-md mx-auto flex items-center justify-around relative">
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 text-xs font-medium cursor-pointer transition-colors ${
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 text-xs font-medium cursor-pointer transition-colors ${
            activeTab === "playlists" ? "text-orange-600" : "text-stone-400 hover:text-stone-600"
          }`}
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
